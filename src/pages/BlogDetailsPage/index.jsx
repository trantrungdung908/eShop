...
import useBlogDetail from "./components/useBlogDetail";
import { formatDate } from "@/utils/format";
import BlogTags from "./components/BlogTags";
import RelatedPost from "./components/RelatedPost";

const BlogDetailsPage = () => {
  const { blogName, blogData, relatedBlogProps, relatedTags } = useBlogDetail();
  const { image, createdAt, author, description } = blogData;
            ...
            <div className="col-lg-9">
              <article className="entry single-entry">
                <div className="entry-body">
                  ...
                  <h1 className="entry-title entry-title-big">{blogName}</h1>
                  ...
                  <div className="entry-footer row no-gutters flex-column flex-md-row">
                    <BlogTags relatedTags={relatedTags} />
              ...
              <div className="related-posts">
                ...
                <div
                  // className="owl-carousel owl-carousel owl-simple owl-loaded owl-drag"
                  style={{ display: "block" }}
                >
                  <RelatedPost {...relatedBlogProps} />
                </div>
              </div>
